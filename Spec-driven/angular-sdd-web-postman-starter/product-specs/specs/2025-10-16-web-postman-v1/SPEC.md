...
- Angular 19 standalone; Jest; Selenium E2E.
...
- UI (Angular) + Node/Express proxy (api-mw).
...
## 5. Non-Functionals
- Perf: UI TTI < 2s; send round-trip overhead from proxy < 50ms internal.
...
## 7. Scaffolding Rules
- Angular 19, standalone; routing; feature modules; Material optional.
